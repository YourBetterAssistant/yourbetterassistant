...
module.exports = {
    ...
    run:async(client, interaction)=>{
        try{
            ...
            https.get({host: "yourbetterassistant.me"}, function(res){
                if( res.statusCode === 200 )
                    return interaction.editReply('The Webserver Returned A 200 OK!')
                        ...
                        interaction.editReply('The Webserver Returned a '+res.statusCode+' '+res.statusMessage)
            ...
            interaction.editReply('An Error Occured While Pinging The Webserver A bug report will be sent')
