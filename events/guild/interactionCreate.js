            ...
            if(interaction.message.id===possibleReaction.messageId){
                if(interaction.customId==possibleReaction.role1.name){
                    ...
                    if(interaction.member.roles.cache.get(possibleReaction.role1.id)){
                        ...
                        interaction.reply({content:`The role ${role} has been removed from you click the button again to get it back`, ephemeral:true})
                    }
                    else{
                    ...
                    interaction.guild.roles.fetch()
                    const role=interaction.guild.roles.cache.get(possibleReaction.role2.id)  
